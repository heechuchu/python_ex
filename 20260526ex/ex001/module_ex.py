# 자주 사용하는 모듈 : 내장 모듈 
# 이러한 내장 모듈들은 절대로 외우는 것이 아님.
# 따라서 가볍게 훑어보고 필요할 때 찾아서 사용함
...
# random 모듈 : 난수를 발생 시키는 모듈 
'''
random(): 0 이상 1 미만의 난수를 발생
randint(n1, n2): n1 이상 n2 이하의 난수 발생
randrange(n1 , n2): n1 이상 n2 미만 난수 발생
sample(range(n1, n2), n3): n1 이상 n2 미만 난수 n3개 발생
...
print(f'sample(): {random.sample(range(0, 10), 3)}')  # 0 이상 10미만 3개 난수
...
lt = time.localtime() # 시스템시간
print(f'lt: {lt}')

print(f'년도: {lt.tm_year}') # 년도
